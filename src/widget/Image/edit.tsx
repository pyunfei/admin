...
const Index = (props: IProps) => {
  ...
  const editPreview = (flag: string) => {
    const _:_Func = {
      'in': () => setScale(his => his + 1),
      'out': () => {
        if (scale === 1) return;
        setScale(his => his - 1)
      },
      'right': () => setRotate(his => his + 90),
      'left': () => setRotate(his => his - 90),
    }
  ...
  return <>
    <div className={styles.container}>
      <ul className={styles.image_preview}>
        <li className={styles.preview_item} onClick={closePreview}>
          <span role="img" aria-label="close" className="">
            <svg viewBox="64 64 896 896" focusable="false" data-icon="close" width="1em" height="1em" fill="currentColor" aria-hidden="true">
              <path d="M563.8 512l262.5-312.9c4.4-5.2.7-13.1-6.1-13.1h-79.8c-4.7 0-9.2 2.1-12.3 5.7L511.6 449.8 295.1 191.7c-3-3.6-7.5-5.7-12.3-5.7H203c-6.8 0-10.5 7.9-6.1 13.1L459.4 512 196.9 824.9A7.95 7.95 0 00203 838h79.8c4.7 0 9.2-2.1 12.3-5.7l216.5-258.1 216.5 258.1c3 3.6 7.5 5.7 12.3 5.7h79.8c6.8 0 10.5-7.9 6.1-13.1L563.8 512z"></path>
            </svg>
          </span>
        </li>
        <li className={styles.preview_item} onClick={() => editPreview('in')}>
          <span role="img" aria-label="zoom-in" className="">
        ...
        <li className={styles.preview_item} onClick={() => editPreview('out')}>
          <span role="img" aria-label="zoom-out" className={scale === 1 ? styles.img_disabled : ''}>
        ...
        <li className={styles.preview_item} onClick={() => editPreview('right')}>
          <span role="img" aria-label="rotate-right" className="">
        ...
        <li className={styles.preview_item} onClick={() => editPreview('left')}>
          <span role="img" aria-label="rotate-left" className="">
      ...
      <div className={styles.image_container}>
        <img alt="" style={{ transform: `scale3d(${scale}, ${scale}, 1) rotate(${rotate}deg)` }} src={sources} />
      </div>
    </div>
  </>
};
